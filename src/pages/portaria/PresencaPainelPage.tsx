  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Painel de Presença / Evacuação</h1>
          <p className="text-sm text-muted-foreground mt-1">Quem está dentro da unidade agora — visão operacional para emergências</p>
        </div>
        <Button variant="destructive" size="sm"><AlertTriangle className="mr-1.5 h-4 w-4" />Modo Evacuação</Button>
      </div>
      ...
      <div className="glass-card rounded-lg p-5">
        <h3 className="text-sm font-semibold text-foreground mb-4">Lista Operacional — Presentes na Unidade</h3>
        <Table>
          <TableHeader>
            <TableRow>
