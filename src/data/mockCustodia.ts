...
export const mockCustodias: CustodiaNF[] = [
  {
    ...
    dataEmissao: "2026-03-07", dataSaidaPortaria: "2026-03-07T10:00:00",
...
export const mockCustodiaKPIs: CustodiaKPIs = {
  nfsEmTransito: 3,
  nfsEmRisco: 2,
  nfsAtrasadas: 2,
  nfsSemConfirmacao: 2,
  nfsComDivergencia: 1,
  entregasComRessalva: 0,
  devolucoes: 0,
  leadTimeMedio: 4.2,
  slaRota: 68,
  envelhecimentoMedio: 4.5,
};
