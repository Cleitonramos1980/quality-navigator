...
export async function inspecoesRoutes(app: FastifyInstance) {
  // ── Modelos ──
  // ── Modelos ──
  app.get("/api/inspecoes/modelos", async () => modelos.list());
  ...
  app.post("/api/inspecoes/modelos", async (req) => modelos.create(req.body as any));
  ...
  // ── Execuções ──
  app.get("/api/inspecoes/execucoes", async () => execucoes.list());
  ...
  app.post("/api/inspecoes/execucoes", async (req) => execucoes.create(req.body as any));

  // ── Tipos NC ──
  app.get("/api/inspecoes/tipos-nc", async () => tiposNc.list());
  app.post("/api/inspecoes/tipos-nc", async (req) => tiposNc.create(req.body as any));
  ...
  // ── Padrões de Mola ──
  app.get("/api/inspecoes/molas/padroes", async () => padroesMola.list());
  app.post("/api/inspecoes/molas/padroes", async (req) => padroesMola.create(req.body as any));
  ...
  // ── Inspeções de Mola ──
  app.get("/api/inspecoes/molas", async () => inspecoesMola.list());
  ...
  app.post("/api/inspecoes/molas", async (req) => inspecoesMola.create(req.body as any));
}
